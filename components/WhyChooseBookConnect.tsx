  ...
  return (
    <section className="min-h-[1300px] sm:min-h-[1200px] relative overflow-hidden pb-10">
      ...
      <div className="container  pt-10 flex flex-col lg:flex-row justify-between gap-10">
        <div className="basis-[calc(50%-40px)] mb-2">
          <div className="max-w-[510px] space-y-[30px]">
            <div className="relative z-20">
              <Image
                ...
                height={376}
                quality={80}
                className="object-contain relative z-50 rounded-b-lg rounded-tl-lg rounded-tr-[104px]"
        ...
        <div className="basis-[calc(50%-40px)] mt-[50px] sm:mt-[150px] lg:mt-[400px">
          <div className="max-w-[510px] ] ml-auto space-y-[30px]">
            ...
            <div className="relative z-20">
              <Image
                ...
                height={376}
                quality={80}
                className="object-contain z-50 relative rounded-t-lg rounded-bl-[104px] rounded-br-lg"
                src={"/images/personalization.png"}
                alt="tarifalhasan"
              />
            </div>
      ...
      {/* shape 1 */}
      <div className="h-[356px] sm:h-[438px] xl:h-[572px] absolute left-[-2%] lg:left-0 top-[24%] lg:top-[23%] sm:top-[18%] z-10 rounded-br-[60px] w-full lg:w-[50%] border border-l-[0] border-brand-main"></div>
      {/* shape 2 */}
      <div className="h-[540px] sm:h-[572px] absolute right-[-2%] top-[53%] sm:top-[50%] lg:top-[30%] z-10 rounded-tl-[60px] w-full border-r-0 lg:w-[50%] border border-brand-main"></div>
    </section>
  );
};
